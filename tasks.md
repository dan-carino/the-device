...
- [ ] **Task 5.1** — Entity definitions + EntityResolver
...
- [ ] **Task 5.2** — Oscilloscope state transitions
...
- [ ] **Task 5.3** — Entity canvas render functions (entities 1–3)
...
- [ ] **Task 5.4** — Entity canvas render functions (entities 4–5) + data strips
